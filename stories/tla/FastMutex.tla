...
Init == (* Global variables *)
        ...
        /\ pc = [self \in ProcSet |-> CASE self \in 1..N -> "ncs"]
...
Proc(self) == ncs(self) \/ start(self) \/ l1(self) \/ l2(self) \/ l3(self)
                 \/ l4(self) \/ l5(self) \/ l6(self) \/ l7(self) \/ l8(self)
                 \/ l9(self) \/ l10(self) \/ cs(self) \/ l11(self) \/ l12(self)
...
\* Last modified Mon Oct 31 15:27:21 CET 2011 by weigla
\* Created Fri Oct 28 23:39:19 CEST 2011 by weigla
